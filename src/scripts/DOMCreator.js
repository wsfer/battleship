class DOMCreator {
    ...
    createFleetPage() {
        ...
        for (let i = 0; i < 100; i++) {
            board += `<div class="square" data-x="${Math.floor(
                i / 10
            )}" data-y="${i % 10}"></div>`;
        }
        ...
        return this.#range.createContextualFragment(`
            ...
            <section>
                ...
                <section class="fleet-selection-board">
                    <div class="x-coords"></div>
                    <div class="y-coords"></div>
                    <div class="gameboard js-gameboard">
                        ${board}
                    </div>
                </section>
                <section class="ship-selection-board">
    ...
    createGamePage() {
        ...
        return this.#range.createContextualFragment(`
            <p>
                <span class="js-turn">Your</span> turn
            </p>
            <section>
                ...
                <section class="computer-board">
                    <h3>Computer fleet</h3>
                    <section class="computer-fleet">
                        <div class="fleet">
                            <div class="x-coords"></div>
                            <div class="y-coords"></div>
                            <div class="gameboard js-gameboard">
